...
EVAL_FILES_PATH=$PX_PATH/examples/Robotwin/eval_files/parallel_eval/
...
export PYTHONPATH="$ROBOTWIN_PATH:$EVAL_FILES_PATH:$PX_PATH:${PYTHONPATH}"
cd "$ROBOTWIN_PATH"
