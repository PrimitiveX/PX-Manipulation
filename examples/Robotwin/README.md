...
2. Running the evaluation by launching services in both `PX` and `robotwin` environments.  
...
Please download Checkpoint from [🤗 PX-M0-Robotwin2](https://huggingface.co/acvlab/PX-M0-RoboTwin2). You should replace the `base_vlm` in the `config.yaml` file with your own path.
