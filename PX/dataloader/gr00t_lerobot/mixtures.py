...
robocoin_mapping_jsons= [str(REPO_ROOT / "PX/dataloader/gr00t_lerobot/robot_type_map/RoboCoin.json"),
                         str(REPO_ROOT / "PX/dataloader/gr00t_lerobot/robot_type_map/RoboCoin_Dexterous.json")]
try:
    ...
    print(f"Warning: Skipping RoboCOIN mixture: {e}")
######################################################## Galaxea ########################################################
...
galaxea_mapping_jsons = [str(REPO_ROOT / "PX/dataloader/gr00t_lerobot/robot_type_map/Galaxea.json")]
try:
    ...
    print(f"Warning: Skipping galaxea mixture: {e}")
######################################################## AgiBotWorld ########################################################
...
agibotworld_mapping_jsons = [str(REPO_ROOT / "PX/dataloader/gr00t_lerobot/robot_type_map/AgiBotWorld.json")]
try:
    ...
    print(f"Warning: Skipping agibotworld mixture: {e}")
######################################################## OxeAuge ########################################################

oxeauge_mixture_name = 'oxeauge'
rel_oxeauge_path = "OXE-AugE"
abs_oxeauge_path = str(DATASETS_ROOT / rel_oxeauge_path)
oxeauge_mapping_jsons = str(REPO_ROOT / "PX/dataloader/gr00t_lerobot/robot_type_map/OXE-Auge.json")
...
try:
    ...
    print(f"Warning: Skipping oxeauge mixture: {e}")
######################################################## InternData-A1 ########################################################
...
intern_mapping_jsons = [str(REPO_ROOT / "PX/dataloader/gr00t_lerobot/robot_type_map/InternData-A1_articulation_tasks.json"),
                        str(REPO_ROOT / "PX/dataloader/gr00t_lerobot/robot_type_map/InternData-A1_long_horizon_tasks.json"),
                        str(REPO_ROOT / "PX/dataloader/gr00t_lerobot/robot_type_map/InternData-A1_basic_tasks.json"),
                        str(REPO_ROOT / "PX/dataloader/gr00t_lerobot/robot_type_map/InternData-A1_pick_and_place_tasks.json")]
...
try:
    ...
    print(f"Warning: Skipping interndata mixture: {e}")
######################################################## Libero ########################################################
...
libero_mapping_jsons = [str(REPO_ROOT / "PX/dataloader/gr00t_lerobot/robot_type_map/Libero.json")]
try:
    ...
    print(f"Warning: Skipping libero mixture: {e}")
######################################################## RoboTwin ########################################################

robotwin_mixture_name = 'robotwin'
_ROBOTWIN_DATA_ROOT = Path("/root/autodl-tmp/data/RoboTwin-Randomized")
rel_robotwin_path = ["Clean",
                     "Randomized"]
abs_robotwin_path = [str(_ROBOTWIN_DATA_ROOT / rel_path) for rel_path in rel_robotwin_path]
robotwin_mapping_jsons = [str(REPO_ROOT / "PX/dataloader/gr00t_lerobot/robot_type_map/Robotwin_clean.json"),
                          str(REPO_ROOT / "PX/dataloader/gr00t_lerobot/robot_type_map/Robotwin_random.json")]
...
try:
    ...
    print(f"Warning: Skipping robotwin mixture: {e}")
######################################################## RoboCase ########################################################
...
robotcase_mapping_jsons = [str(REPO_ROOT / "PX/dataloader/gr00t_lerobot/robot_type_map/RoboCase.json")]
try:
    ...
    print(f"Warning: Skipping robocase_gr1 mixture: {e}")
############################################## Mixtures ########################################################
mixture_ratios = {
    "oxe": 0.17,
    "oxeauge": 0.15,
