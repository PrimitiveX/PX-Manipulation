...
from PX.training.trainer_utils import initialize_overwatch
...
from PX.model.framework.base_framework import baseframework
from PX.model.modules.vlm import get_vlm_model
from PX.model.modules.action_model.AML_ActionHeader import get_action_model, FlowmatchingActionHead
from PX.training.trainer_utils.trainer_tools import resize_images
from PX.model.tools import FRAMEWORK_REGISTRY

from vggt.models.vggt import VGGT
from PX.model.modules.vggt_tools import preprocess_images, CrossAttention

@FRAMEWORK_REGISTRY.register("PX_M0")
class PX_M0(baseframework):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_yaml", type=str, default="./PX/config/training/PX_pretrain.yaml", help="Path to YAML config")
    ...
    from PX.dataloader.lerobot_datasets import get_vla_dataset, collate_fn
