...
# Local Modules
from PX.training.trainer_utils.trainer_tools import normalize_dotlist_args
from PX.model.framework import build_framework
from PX.training.trainer_utils.trainer_tools import TrainerUtils
from PX.training.trainer_utils.trainer_tools import build_param_lr_groups
from PX.training.trainer_utils.config_tracker import wrap_config, AccessTrackedConfig
...
from PX.dataloader import build_dataloader
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_yaml", type=str, default="PX/config/training/PX_cotrain_oxe.yaml", help="Path to YAML config")
